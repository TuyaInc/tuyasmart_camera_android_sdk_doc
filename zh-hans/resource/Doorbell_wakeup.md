...
1. 可以从[系统的推送信息](https://tuyainc.github.io/tuyasmart_home_android_sdk_doc/zh-hans/resource/MessagePush.html)中获取，其中如果消息体中携带有type=doorbell，即可判断为门铃推送消息
...
2. 也可以注册门铃推送消息监听，在app进程活着的时候，提升消息的到达率和速度
